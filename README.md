...
| `tests/` | The engine's own suite. It runs with nothing installed — `PYTHONPATH=src python3 -m unittest` — which is what lets CI run it on an interpreter at the version floor. |
