...
| `.claude/docs/` | Working notes for the implementing AI: the measured behaviour of the harness and of that guard, each with its version and a recipe to re-measure it. Notes, not deliverables — `docs/` will hold the documentation for humans (§12). |
