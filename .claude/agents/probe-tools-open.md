---
name: probe-tools-open
description: Measurement fixture for step 003 — the control arm of the `tools:` frontmatter probe. Its frontmatter grants Read and Bash. Not a working agent; delete it at step 004 when the real agents land.
tools: Read, Bash
---
